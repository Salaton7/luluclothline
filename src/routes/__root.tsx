...
function StickyWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-whatsapp px-5 py-3.5 text-whatsapp-foreground shadow-lg shadow-foreground/20 transition-transform hover:scale-105 md:bottom-8 md:right-8"
    >
      ...
      <span className="tracking-luxury text-[11px] hidden sm:inline">Order on WhatsApp</span>
    </a>
  );
}
}
