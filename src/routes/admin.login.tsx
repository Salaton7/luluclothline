      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="tracking-luxury text-[10px] text-muted-foreground">or</span>
            <div className="h-px flex-1 bg-border" />
          </div>
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-full border border-border bg-background py-3 text-sm font-medium transition-colors hover:bg-accent"
          >
